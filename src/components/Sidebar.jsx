...
//     const role = "ADMIN" || "EMPLOYEE"; // Example role, replace with actual user role
//     const navItems = [
...
const Sidebar = () => {
  ...
  // EMP USER NAME (replace later with API)
  useEffect(() => {
  ...
  return (
    <aside className='w-64 h-screen bg-slate-900 text-white flex flex-col'>
      ...
      <div className='px-5 pt-6 pb-5 border-b border-white/10 flex items-center gap-3'>
        ...
        <div>
          <p className='font-semibold text-sm'>Employee MS</p>
          <p className='text-xs text-gray-400'>Management System</p>
        </div>
      </div>

      {/* USER PROFILE WITH LETTER ICON */}
      <div className='mx-3 mt-4 mb-2 p-3 rounded-lg bg-white/5 flex items-center gap-3'>
